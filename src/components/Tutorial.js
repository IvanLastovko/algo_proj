    ...
    if (tutorialOpen) {
        return (<div className={'tutorial_box'} onClick={() => setTutorialOpen(false)}>
                <div className={'tutorial_text'} onClick={() => setTutorialOpen(true)}>
                    <br></br>
                    <h1>What's RegEx? <sup><a href={'https://en.wikipedia.org/wiki/Regular_expression'}>[1]</a></sup></h1>
                    ...
                    <p className={'p'}>A regular expression, often called a pattern, specifies a set of strings required
                        ...
                        it.</p>
                    <h1>Nondeterministic finite automaton <sup><a href={'https://en.wikipedia.org/wiki/Nondeterministic_finite_automaton'}>[2]</a></sup></h1>
                    ...
                    <h1>Thompson's construction algorithm <sup><a href={'https://en.wikipedia.org/wiki/Thompson%27s_construction'}>[3]</a></sup></h1>
                    ...
                    <h1>Deterministic finite automaton <sup><a href={'https://en.wikipedia.org/wiki/Deterministic_finite_automaton'}>[4]</a></sup></h1>
                    ...
                    <p className={'p'}></p>
                    <h1>DFA minimization <sup><a href={'https://en.wikipedia.org/wiki/DFA_minimization'}>[5]</a></sup></h1>
